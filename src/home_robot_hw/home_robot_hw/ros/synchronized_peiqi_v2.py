...
class SynchronizedSensors(object):
    ...
    def _rgb_callback(self, color):
        ...
        # if not hasattr(self, 'color_time_step'):
    ...
    def _pose_callback(self, pose):
        # if not hasattr(self, 'pose_time_step'):
        #     self.pose_init_time = pose.header.stamp.to_sec()
        # self.pose_time_step = pose.header.stamp.to_sec()
        # self.pose_number = 1 if not hasattr(self, 'pose_number') else self.pose_number + 1
        # if self.pose_number % 1000 == 0:
        #     print('pose freq ', (self.pose_time_step - self.pose_init_time) / self.pose_number)
